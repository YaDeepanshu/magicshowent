...
<?php 
if(isset($_GET['user_logout']) && !empty($_GET['user_logout'])){
	unset($_SESSION['user_login_details']);
}
?>
<div class="banner">
	<div class="owl-carousel owl-theme owl1">
		...
		<div class="item">
			<img src="images/3.png" href="poater 1" class="owlimg">
		</div>
	</div>
</div>
<div class="container">
		...
		<?php } }?>
			...
			<div class="item">
				<div class="item-wrapper2">
					<a href="allmovies.php">Show All</a>
				</div>
			</div>
		</div>
	</div>
	<div class="movie">
		...
		<div class="owl-carousel owl-theme owl3">
			...
			?>
			<div class="item">
				<img src="thumb/music/<?php echo $frow['img'] ?>" class="song_img" style="max-width: 100%;">
				<div class="item-wrapper">
					<p><?php echo $frow['mv_name'] ?></p>
		...
		<?php } }?>
			...
			<div class="item">
				<div class="item-wrapper4">
					<a href="allmusic.php">Show All</a>
				</div>
			</div>
		</div>
	</div>
	<div class="movie">
		...
		<div class="owl-carousel owl-theme owl3">
			...
			?>
			<div class="item">
				<img src="thumb/games/<?php echo $frow['img'] ?>" style="max-width: 100%;">
				<div class="item-wrapper">
					<p><?php echo $frow['mv_name'] ?></p>
		...
		<?php } }?>
			...
			<div class="item">
				<div class="item-wrapper3">
					<a href="allgames.php">Show All</a>
				</div>
			</div>
		</div>
	</div>
	<div class="newsletter">
		<?php 
			...
			if($run==true){
				$result= "<p style='color:green;'>Registered for Newsletter.</p>";
			}else{
		...
		<span id='session'><?php echo $result; ?></span>
		</form>
	</div>
</div>
